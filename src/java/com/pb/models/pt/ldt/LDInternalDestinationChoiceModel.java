...
//        IndustryOccupationSplitIndustryReference indOccRef = new IndustryOccupationSplitIndustryReference(occRefFile);
    ...
    public void buildModel(TazManager tazData) { 
        ...
        Matrix distance = LDSkimsInMemory.getOffPeakMatrix(LDTourModeType.AUTO, "Dist");
        Matrix time = LDSkimsInMemory.getOffPeakMatrix(LDTourModeType.AUTO, "Time");
    ...
    private Matrix aggregateToSlats(TazByAmz tba, 
        ...
        logger.info("Aggregating " + zonalMatrix.getName()
