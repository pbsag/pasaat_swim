...
//    protected HsrDrive hsrDrive;
    ...
    public LDInternalModeChoiceModel(ResourceBundle globalRb, ResourceBundle rb,
        ...
        readParameters();
        skims = LDSkimsInMemory.getInstance(); 
        buildModel(); 
    }
...
//        hsrNest.setDispersionParameter(groundNest.getDispersionParameter() / parameters[0][NESTHSR]);
     ...
     * @return     The travel time and ocst for all modes for that tour.  
     */
    private LDTravelTimeAndCost setTravelTimeAndCost(LDTour tour) {
        LDTravelTimeAndCost impedance = null; 
        ...
        case END_TOUR : 
            ...
            break;
        case COMPLETE_TOUR :
            LDTravelTimeAndCost outboundImpedance = skims.setTravelTimeAndCost(
                    tour.homeTAZ, tour.destinationTAZ,
                    tour.schedule.getDepartureMilitaryTime());
            LDTravelTimeAndCost inboundImpedance = skims.setTravelTimeAndCost(
                    tour.destinationTAZ, tour.homeTAZ,
                    tour.schedule.getArrivalMilitaryTime());
            impedance = LDTravelTimeAndCost.addTimeAndCost(outboundImpedance, inboundImpedance); 
            break;
        default: 
     ...
     */
    private double calculateUtility(LDTravelTimeAndCost impedance,
...
//            }
    ...
    public Matrix createLogsumMatrix(LDTourPurpose purpose) {
        ...
        for (Taz originTaz : tazManager.values()) {
            ...
            for (Taz destinationTaz : tazManager.values()) {
                ...
                LDTravelTimeAndCost impedance = setTravelTimeAndCost(dummyTour);
    ...
    public LDTourModeType chooseMode(LDTour tour, boolean sensitivityTesting) {
        ...
        LDTravelTimeAndCost impedance = setTravelTimeAndCost(tour);
